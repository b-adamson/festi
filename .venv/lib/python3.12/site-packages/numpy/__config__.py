...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"C:/msys64/mingw64/include/openblas",
                "lib directory": r"C:/msys64/mingw64/lib",
                ...
                "pc file directory": r"C:\msys64\mingw64\lib\pkgconfig",
            },
            "lapack": {
                "name": "openblas",
                "found": bool("True".lower().replace("false", "")),
        ...
        "Python Information": {
            "path": r"C:\Users\beada\dev\Projects\festi\billy-adamson\festi\.venv\bin\python.exe",
            "version": "3.12",
        },
        "SIMD Extensions": {
