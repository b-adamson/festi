...
Transform& Transform::randomOffset(
	...
	if (maxOff.rotation != glm::vec3{} || minOff.rotation != glm::vec3{}) {
		rotation += 
			(minOff.rotation[0] + dis(gen) * (maxOff.rotation[0] - minOff.rotation[0])) * glm::normalize(glm::vec3{1,0,0}) +
			(minOff.rotation[1] + dis(gen) * (maxOff.rotation[1] - minOff.rotation[1])) * glm::normalize(glm::vec3{0,1,0}) +
			(minOff.rotation[2] + dis(gen) * (maxOff.rotation[2] - minOff.rotation[2])) * glm::normalize(glm::vec3{0,0,1});
	}
